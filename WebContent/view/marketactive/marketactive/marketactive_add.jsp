	...
	<div class="row">
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="starDate" class="form-control input-sm" placeholder="请输入开始时间"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
   ...
   <!--结束 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="endDate" class="form-control input-sm" placeholder="请输入结束时间"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
    ...
    <!--开始 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-6">
                	<input type="text" name="costEmtimente" class="form-control input-sm" placeholder="请输入成本预算"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                	<input type="text" name="realCost" class="form-control input-sm" placeholder="请输入实际成本"/>
                </div>
            </div>
        </div>
    </div>
   ...
   <!--开始 -->
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                	<input type="text" name="expectStudent" class="form-control input-sm" placeholder="请输入预期学员"/>
                </div>
            </div>
        </div>
    </div>
