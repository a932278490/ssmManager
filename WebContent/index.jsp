			...
			<div class="sidebar" id="sidebar">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="view/system/staffinfo/staffinfo_list.html" target="mainframe"> <i
			  ...
			  <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="tem.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 模板管理
							</a></li>
                             <li><a href="msg.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 短信管理
							</a></li>       
                            <li><a href="ema.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 邮件管理
							</a></li>   
                            <li><a href="act.do?findAll" target="mainframe"> <i
						...
						<ul class="submenu">
                            ...
                            <li><a href="student.do?StudentPool" target="mainframe"> <i
									class="icon-double-angle-right"></i> 学员池
							</a></li>
                            <li><a href="student.do?findXianSuo" target="mainframe"> <i
									class="icon-double-angle-right"></i> 招生线索
							</a></li> 
                            <li><a href="track.do?trackAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 跟踪记录
							</a></li>
                            <li><a href="audition.do?auditionAll" target="mainframe"> <i
               ...
               <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="subject.do?find" target="mainframe"> <i
									class="icon-double-angle-right"></i> 学科信息
							</a></li>
                            <li><a href="classRoom.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 教室信息
							</a></li>
                             <li><a href="schedule.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 课程表
							</a></li>   
                            <li><a href="teacher.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 教师管理
							</a></li>    
                            <li><a href="classes.do?find" target="mainframe"> <i
						...
						<ul class="submenu">
                            <li><a href="student.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 学员信息
							</a></li>
                            <li><a href="evaluation.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 学员评价
							</a></li>
                            <li><a href="communicate.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 沟通记录
							</a></li>
                            <li><a href="grade.do?findAll" target="mainframe"> <i
                   ...
                   <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            <li><a href="trans.do?findAll" target="mainframe"> <i
									class="icon-double-angle-right"></i> 班级事务
							</a></li>
                            <li><a href="attend.do?findAll" target="mainframe"> <i
						...
						<ul class="submenu">
                            <li><a href="stupay.do?findstu" target="mainframe"> <i
									class="icon-double-angle-right"></i> 学员缴费
							</a></li>
                            <li><a href="stasal.do?findall" target="mainframe"> <i
